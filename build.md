...
| --- | --- | ---: | --- | --- | --- | --- |
| 2026-07-22 16:52 | 2.3.5 | 260722009 | GitHub 正式发布：Android split APK、Windows、Linux、macOS universal、公证、Web 部署与官网镜像 | 构建中 | 待确认 | 已占用构建号；正在统一版本与更新日志并执行发布前验证，GitHub Release、签名公证产物和官网验证待回写 |
