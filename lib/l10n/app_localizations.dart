...
abstract class AppLocalizations {
  ...
  /// No description provided for @legadoCompatibilityTitle.
  ///
  /// In en, this message translates to:
  /// **'Legado compatibility (Beta)'**
  String get legadoCompatibilityTitle;

  /// No description provided for @legadoCompatibilitySubtitle.
  ///
  /// In en, this message translates to:
  /// **'Imported rules are scanned before any compatible runtime is enabled'**
  String get legadoCompatibilitySubtitle;

  /// No description provided for @legadoImport.
  ///
  /// In en, this message translates to:
  /// **'Import Legado'**
  String get legadoImport;
  ...
  /// No description provided for @legadoImportNotice.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @legadoChooseFile.
  ///
  /// In en, this message translates to:
  /// **'Choose JSON file'**
  String get legadoChooseFile;

  /// No description provided for @legadoJsonLabel.
  ///
  /// In en, this message translates to:
  /// **'Legado source JSON'**
  String get legadoJsonLabel;
  ...
  /// No description provided for @legadoFileTooLarge.
  ///
  /// In en, this message translates to:
  /// **'The source file exceeds the 2 MB import limit.'**
  String get legadoFileTooLarge;

  /// No description provided for @legadoFileReadFailed.
  ///
  /// In en, this message translates to:
  /// **'The selected file could not be read.'**
  String get legadoFileReadFailed;

  /// No description provided for @legadoImportedCount.
  ///
  /// In en, this message translates to:
  /// **'Imported {count} Legado sources'**
  String legadoImportedCount(int count);

  /// No description provided for @legadoNoSources.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @legadoLite.
  ///
  /// In en, this message translates to:
  /// **'Lite compatible'**
  String get legadoLite;

  /// No description provided for @legadoAdapterRequired.
  ///
  /// In en, this message translates to:
  /// **'Adapter required'**
  String get legadoAdapterRequired;

  /// No description provided for @legadoUnsupported.
  ///
  /// In en, this message translates to:
  /// **'Unsupported'**
  String get legadoUnsupported;
